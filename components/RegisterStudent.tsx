  ...
  const RegisterStudent: React.FC<RegisterStudentprops> = ({ ruta }) => {
    ...
    const pressLoginButton = async () => {
      ...
      try {
        ...
        alert('Error al agregar el estudiantef');
    }
    };
    ...
    return(
        <View style={styles.formContainer}>
            ...
            <TextInput style={styles.input} value={curso} onChangeText={setCurso} placeholder="Introduce el curso" />
            ...
            <Picker
              selectedValue={selectedNecesidad}
              onValueChange={(itemValue) => setSelectedNecesidad(itemValue)}
              style={styles.picker}
            >
